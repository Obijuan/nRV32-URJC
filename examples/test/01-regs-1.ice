{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c4f86052-edf3-4861-b17c-342f2a192282",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "6a6176d6-c5d6-4222-a70f-fc53ce2d7fa8",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "1",
        ...
        {
          "id": "5e525bec-2e3d-4f53-97eb-d0305ec76cac",
        ...
        {
          "id": "1d2158ba-e17c-46ec-8199-b10b510b5b1f",
        ...
        {
          "id": "aa628ce5-5142-4010-9981-dafd5127a095",
          "type": "4fc6d2445e9ac662479924fc51ecd996a8161705",
          "position": {
            "x": 856,
            "y": 328
          },
        ...
        {
          "id": "44883ef1-05b6-4240-b5cd-6b2027d62cd8",
          "type": "21cfcc19a4ad14c5fb5e8cfebd018ec356fe7542",
          "position": {
            "x": 456,
            "y": 696
        ...
        {
          "id": "ae3d7b7d-6aae-4810-9a2e-6597b22c34f4",
        ...
        {
          "id": "393804aa-883b-4225-92fb-d18d51b5dc99",
          "type": "e0b4f6a60e86c362004d3fc397297e8b3277da9e",
          "position": {
            "x": 632,
            "y": 320
          },
      ...
      "wires": [
        {
          "source": {
            "block": "5e525bec-2e3d-4f53-97eb-d0305ec76cac",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "393804aa-883b-4225-92fb-d18d51b5dc99",
        ...
        {
          "source": {
            "block": "6a6176d6-c5d6-4222-a70f-fc53ce2d7fa8",
            "port": "constant-out"
          },
          "target": {
            "block": "1d2158ba-e17c-46ec-8199-b10b510b5b1f",
        ...
        },
        {
          ...
          "target": {
            "block": "393804aa-883b-4225-92fb-d18d51b5dc99",
            "port": "46a4bf30-cefa-49ff-9ea7-ebddfb0a7308"
          },
          "vertices": [
            {
              "x": 464,
        ...
        },
        {
          "source": {
            "block": "393804aa-883b-4225-92fb-d18d51b5dc99",
            "port": "7b2b9812-6da5-48ce-b1ab-47afe470c81d"
          },
          "target": {
            "block": "aa628ce5-5142-4010-9981-dafd5127a095",
        ...
        },
        {
          "source": {
            "block": "aa628ce5-5142-4010-9981-dafd5127a095",
            "port": "7dd8ce94-7783-41a7-a175-a4314a08aabd"
          },
          "target": {
            "block": "c4f86052-edf3-4861-b17c-342f2a192282",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "44883ef1-05b6-4240-b5cd-6b2027d62cd8",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "393804aa-883b-4225-92fb-d18d51b5dc99",
        ...
        {
          "source": {
            "block": "ae3d7b7d-6aae-4810-9a2e-6597b22c34f4",
  ...
  "dependencies": {
    ...
    "4fc6d2445e9ac662479924fc51ecd996a8161705": {
      "package": {
        "name": "Split-24-8",
        "version": "0.1",
        "description": "Split a 32-bits bus into 24-bits bus and 8-bits bus",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "a4bf8da5-1403-4e8b-be78-6d10db8d1563",
              "type": "basic.output",
              "data": {
                "name": "o1",
                "range": "[23:0]",
            ...
            {
              "id": "7dd8ce94-7783-41a7-a175-a4314a08aabd",
              "type": "basic.output",
              "data": {
                "name": "o0",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "7dd8ce94-7783-41a7-a175-a4314a08aabd",
                "port": "in"
              },
              "size": 8
            },
            {
              ...
              "target": {
                "block": "a4bf8da5-1403-4e8b-be78-6d10db8d1563",
                "port": "in"
              },
              "size": 24
            }
    ...
    "e0b4f6a60e86c362004d3fc397297e8b3277da9e": {
      "package": {
