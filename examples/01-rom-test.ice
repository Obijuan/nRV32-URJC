{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "37d34eb6-badf-4ae3-9fe7-2191be7685e2",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "addr",
        ...
        {
          "id": "c8fcfca3-5c59-44d7-905c-8db206cc261a",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "addr",
        ...
        {
          "id": "6603e588-a2bb-4a9c-a5df-bc02f4fea9f4",
          "type": "2525913d1224cc1f7389e77905377da89d68713b",
          "position": {
            "x": 56,
            "y": 152
          },
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# 01-ROM-test\n\nTesting the Instruction memory. Program TEST-1 is loaded in the ROM memory  \nUsing the button SW2 the current address is increment and the instruction  \nprinted on the serial console. With the button SW1 the address is decremented  \nIt allow us to navigate though the machine code",
            "readonly": true
          },
          "position": {
            "x": -232,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "6603e588-a2bb-4a9c-a5df-bc02f4fea9f4",
        ...
        },
        {
          ...
          "target": {
            "block": "c8fcfca3-5c59-44d7-905c-8db206cc261a",
            "port": "inlabel"
          },
          "size": 3
        },
        ...
        {
          "source": {
            "block": "37d34eb6-badf-4ae3-9fe7-2191be7685e2",
            "port": "outlabel"
          },
          "target": {
            "block": "cdf1c8c1-ea9e-43e9-9968-fcb8284924ad",
            "port": "353aa1fc-16bd-44ce-aa42-a3c9be793091"
          },
          "size": 3
        },
        {
  ...
  "dependencies": {
    ...
    "2525913d1224cc1f7389e77905377da89d68713b": {
      "package": {
        "name": "cont-up-down-3bits CLONE",
        "version": "0.1-c1606994246184",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "8fc99e32-f728-44d6-951c-5b2120203f4b",
              "type": "basic.inputLabel",
              "data": {
                "name": "addr",
                "range": "[2:0]",
            ...
            {
              "id": "353aa1fc-16bd-44ce-aa42-a3c9be793091",
              "type": "basic.input",
              "data": {
                "name": "addr",
                "range": "[2:0]",
            ...
            {
              "id": "2a261922-0ff7-43dc-bd48-7bbd53af6a29",
              "type": "basic.outputLabel",
              "data": {
                "name": "addr",
                "range": "[2:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "2a261922-0ff7-43dc-bd48-7bbd53af6a29",
                "port": "outlabel"
              },
              "target": {
                "block": "f67e4c13-cb1a-4f3f-95aa-0b1768893b03",
            ...
            {
              "source": {
                "block": "353aa1fc-16bd-44ce-aa42-a3c9be793091",
                "port": "out",
                "size": 3
              },
              "target": {
                "block": "8fc99e32-f728-44d6-951c-5b2120203f4b",
                "port": "inlabel"
              },
              "size": 3
            },
